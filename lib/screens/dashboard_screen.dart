                ...
                child: Column(
                  children: [
                    SectionLabel(
                      ...
                      trailing: Text('${activeProjects.length} running',
                          style: kStyleCaption),
                    ),
                        ...
                        return GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: kCardDecoration(
                                borderColor: urgencyBorderColor(urgency)),
                            child: Stack(
                              children: [
                                if (strip != null)
                                  Align(
                    ...
                    return GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ClientAvatar(
                                name: client.name, size: 40, radius: 12),
                            const SizedBox(height: 6),
                            Text(firstName,
                                style: kStyleBodyBold,
                            ...
                            if (client.activeCount > 0)
                              Text('${client.activeCount} active',
                  ...
                  children: [
                    Expanded(
                      child: StatCard(
                        label: 'Owed',
                        value: fmtCurrency(
                            dataProvider.totalOwed, settings.currency),
                        valueColor:
                            dataProvider.totalOwed > 0 ? kYellow : kGreen,
                    ...
                    Expanded(
                      child: Container(
                        ...
                        decoration: kCardDecoration(
                          radius: 20,
                          background: timerProvider.isRunning
                              ? kLime.withOpacity(0.15)
                              : kBgCard,
                          borderColor: timerProvider.isRunning
                              ? kLime.withOpacity(0.40)
                              : kBorder,
                        ),
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            ...
                            if (timerProvider.isRunning)
                              ...
                              Text(fmtDuration(dataProvider.todayMinutes),
                                  style:
                                      kStyleHeadingSm.copyWith(fontSize: 22)),
                            const SizedBox(height: 4),
                            if (timerProvider.isRunning)
                              SizedBox(
                                height: 30,
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              fmtCurrency(dataProvider.totalCollected,
                                  settings.currency),
